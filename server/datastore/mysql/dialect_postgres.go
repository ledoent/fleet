...
// All methods panic — this stub exists only for interface compliance verification.
type postgresDialect struct{}

// Compile-time assertion that postgresDialect satisfies DialectHelper.
var _ DialectHelper = postgresDialect{}

func (postgresDialect) InsertOnDuplicateKeyUpdate(table string, insertCols, updateCols []string, conflictTarget string) string {
...
func (postgresDialect) ReplaceInto(table string, cols []string, conflictTarget string) string {
	panic("postgres: not implemented")
}
