...
--
-- pg-baseline-up-to-migration: 20260522195235
--
--
...
CREATE TABLE public.host_certificates (
    ...
    CONSTRAINT host_certificates_origin_check CHECK (((origin)::text = ANY ((ARRAY['osquery'::character varying, 'mdm'::character varying])::text[])))
);
