...
CREATE TABLE IF NOT EXISTS public.abm_tokens (
    id integer NOT NULL,
...
ALTER TABLE public.abm_tokens ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS public.acme_enrollments (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.activity_host_past (
...
CREATE TABLE IF NOT EXISTS public.activity_past (
    id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    user_id integer,
    user_name character varying(255) DEFAULT NULL::character varying,
...
CREATE TABLE IF NOT EXISTS public.android_app_configurations (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.android_enterprises (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.android_policy_requests (
...
CREATE TABLE IF NOT EXISTS public.app_config_json (
...
CREATE TABLE IF NOT EXISTS public.batch_activity_host_results (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.ca_config_assets (
    id integer NOT NULL,
    type text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.carve_blocks (
...
CREATE TABLE IF NOT EXISTS public.carve_metadata (
    id integer NOT NULL,
    host_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS public.conditional_access_scep_certificates (
...
CREATE TABLE IF NOT EXISTS public.conditional_access_scep_serials (
    serial bigint NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS public.cron_stats (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cve_meta (
...
CREATE TABLE IF NOT EXISTS public.default_team_config_json (
    id integer DEFAULT 1 NOT NULL,
    json_value jsonb NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS public.distributed_query_campaign_targets (
    id integer NOT NULL,
    type integer,
...
CREATE TABLE IF NOT EXISTS public.distributed_query_campaigns (
    id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    query_id integer,
...
CREATE TABLE IF NOT EXISTS public.enroll_secrets (
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.eulas (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.fleet_maintained_apps (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.fleet_variables (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_activities (
    host_id integer NOT NULL,
    activity_id integer NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.host_additional (
    host_id integer NOT NULL,
    additional jsonb
);
...
CREATE TABLE IF NOT EXISTS public.host_batteries (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_calendar_events (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_certificate_sources (
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_certificate_templates (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_certificates (
    id bigint NOT NULL,
    host_id integer NOT NULL,
    not_valid_after timestamp without time zone NOT NULL,
    not_valid_before timestamp without time zone NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_conditional_access (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_dep_assignments (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_device_auth (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_disk_encryption_keys (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_disk_encryption_keys_archive (
    id bigint NOT NULL,
    host_id integer NOT NULL,
    hardware_serial character varying(255) DEFAULT ''::character varying NOT NULL,
    base64_encrypted text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_disks (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_display_names (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_emails (
    id integer NOT NULL,
    host_id integer NOT NULL,
    email character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_identity_scep_certificates (
    serial bigint NOT NULL,
    host_id integer,
    name character varying(255) NOT NULL,
    not_valid_before timestamp without time zone NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_identity_scep_serials (
    serial bigint NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS public.host_in_house_software_installs (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_issues (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_last_known_locations (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_managed_local_account_passwords (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_actions (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_android_profiles (
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_apple_awaiting_configuration (
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_apple_bootstrap_packages (
...
CREATE TABLE IF NOT EXISTS public.host_mdm_apple_declarations (
    host_uuid character varying(255) NOT NULL,
    status character varying(20) DEFAULT NULL::character varying,
    operation_type character varying(20) DEFAULT NULL::character varying,
    detail text,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_apple_profiles (
...
CREATE TABLE IF NOT EXISTS public.host_mdm_commands (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_idp_accounts (
    id integer NOT NULL,
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_managed_certificates (
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_mdm_windows_profiles (
    host_uuid character varying(255) NOT NULL,
    status character varying(20) DEFAULT NULL::character varying,
    operation_type character varying(20) DEFAULT NULL::character varying,
    detail text,
...
CREATE TABLE IF NOT EXISTS public.host_munki_info (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_munki_issues (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_operating_system (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_orbit_info (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_recovery_key_passwords (
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_scim_user (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_script_results (
    id integer NOT NULL,
    host_id integer NOT NULL,
    execution_id character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_seen_times (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_software (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_software_installed_paths (
    id bigint NOT NULL,
    host_id integer NOT NULL,
    software_id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_software_installs (
    id integer NOT NULL,
    execution_id character varying(255) NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_updates (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.host_vpp_software_installs (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.identity_serials (
    serial bigint NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS public.in_house_app_labels (
    id integer NOT NULL,
    in_house_app_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.in_house_app_software_categories (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.in_house_app_upcoming_activities (
...
CREATE TABLE IF NOT EXISTS public.in_house_apps (
    id integer NOT NULL,
    title_id integer,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.invite_teams (
...
CREATE TABLE IF NOT EXISTS public.kernel_host_counts (
    id integer NOT NULL,
    software_title_id integer,
    software_id integer,
...
ALTER TABLE public.kernel_host_counts ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.kernel_host_counts_swap_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
...
CREATE TABLE IF NOT EXISTS public.label_membership (
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    label_id integer NOT NULL,
    host_id integer NOT NULL
...
CREATE TABLE IF NOT EXISTS public.legacy_host_filevault_profiles (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.legacy_host_mdm_enroll_refs (
    id integer NOT NULL,
    host_uuid character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.legacy_host_mdm_idp_accounts (
    id integer NOT NULL,
    host_uuid character varying(255) NOT NULL,
    email character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_android_configuration_profiles (
    profile_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_bootstrap_packages (
    team_id integer NOT NULL,
    name character varying(255) DEFAULT NULL::character varying,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_configuration_profiles (
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_declaration_activation_references (
    declaration_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_declarations (
    declaration_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    identifier character varying(255) NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_declarative_requests (
    id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_default_setup_assistants (
    id integer NOT NULL,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_enrollment_profiles (
    id integer NOT NULL,
    token character varying(36) DEFAULT NULL::character varying,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_installers (
    id integer NOT NULL,
    name character varying(255) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_setup_assistant_profiles (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_apple_setup_assistants (
    id integer NOT NULL,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
    name text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_config_assets (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_configuration_profile_labels (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_configuration_profile_variables (
    id integer NOT NULL,
    apple_profile_uuid character varying(37) DEFAULT NULL::character varying,
    windows_profile_uuid character varying(37) DEFAULT NULL::character varying,
...
CREATE TABLE IF NOT EXISTS public.mdm_declaration_labels (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_delivery_status (
    status character varying(20) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.mdm_idp_accounts (
...
CREATE TABLE IF NOT EXISTS public.mdm_operation_types (
    operation_type character varying(20) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.mdm_windows_configuration_profiles (
    profile_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mdm_windows_enrollments (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.microsoft_compliance_partner_host_statuses (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.microsoft_compliance_partner_integrations (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.migration_status_data (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.migration_status_tables (
    id bigint NOT NULL,
    version_id bigint NOT NULL,
    is_applied boolean NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.mobile_device_management_solutions (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.munki_issues (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_cert_auth_associations (
...
CREATE TABLE IF NOT EXISTS public.nano_command_results (
    id character varying(255) NOT NULL,
    command_uuid character varying(127) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_commands (
    command_uuid character varying(127) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_dep_names (
    name character varying(255) NOT NULL,
    consumer_key text,
...
CREATE TABLE IF NOT EXISTS public.nano_devices (
    id character varying(255) NOT NULL,
    identity_cert text,
...
CREATE TABLE IF NOT EXISTS public.nano_enrollment_queue (
    id character varying(255) NOT NULL,
    command_uuid character varying(127) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_enrollments (
    id character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_push_certs (
    topic character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.nano_users (
    id character varying(255) NOT NULL,
    device_id character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.operating_system_version_vulnerabilities (
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.operating_system_vulnerabilities (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.osquery_options (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.pack_targets (
    id integer NOT NULL,
    pack_id integer,
    type integer,
...
CREATE TABLE IF NOT EXISTS public.policy_automation_iterations (
...
CREATE TABLE IF NOT EXISTS public.policy_labels (
    id integer NOT NULL,
    policy_id integer NOT NULL,
    label_id integer NOT NULL,
    exclude boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.policy_membership (
    policy_id integer NOT NULL,
    host_id integer NOT NULL,
    passes boolean,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.policy_stats (
    id integer NOT NULL,
    policy_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.query_labels (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.scheduled_queries (
    id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    pack_id integer,
...
CREATE TABLE IF NOT EXISTS public.scheduled_query_stats (
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.scim_last_request (
...
CREATE TABLE IF NOT EXISTS public.scim_user_emails (
    id bigint NOT NULL,
    scim_user_id integer NOT NULL,
    email character varying(255) NOT NULL,
    "primary" boolean,
...
CREATE TABLE IF NOT EXISTS public.scim_user_group (
    scim_user_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.script_contents (
    id integer NOT NULL,
    md5_checksum bytea NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.script_upcoming_activities (
    upcoming_activity_id bigint NOT NULL,
    script_id integer,
    script_content_id integer,
    policy_id integer,
...
CREATE TABLE IF NOT EXISTS public.secret_variables (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    value bytea NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.setup_experience_scripts (
    id integer NOT NULL,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.setup_experience_status_results (
    id integer NOT NULL,
    host_uuid character varying(255) NOT NULL,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_cpe (
    id integer NOT NULL,
    software_id bigint,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS public.software_cve (
    id integer NOT NULL,
    cve character varying(255) NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS public.software_host_counts (
    software_id bigint NOT NULL,
    hosts_count integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_install_upcoming_activities (
    upcoming_activity_id bigint NOT NULL,
    software_installer_id integer,
    policy_id integer,
    software_title_id integer,
...
CREATE TABLE IF NOT EXISTS public.software_installer_labels (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_installer_software_categories (
    id integer NOT NULL,
    software_category_id integer NOT NULL,
    software_installer_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS public.software_installers (
    id integer NOT NULL,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
    title_id integer,
...
CREATE TABLE IF NOT EXISTS public.software_title_display_names (
    id integer NOT NULL,
    team_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_title_icons (
    id integer NOT NULL,
    team_id integer NOT NULL,
    software_title_id integer NOT NULL,
    storage_id character varying(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_titles (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    source character varying(64) NOT NULL,
    extension_for character varying(255) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_titles_host_counts (
    software_title_id integer NOT NULL,
    hosts_count integer NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_update_schedules (
    id integer NOT NULL,
    team_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.user_api_endpoints (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vpp_app_team_labels (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vpp_app_team_software_categories (
    id integer NOT NULL,
    software_category_id integer NOT NULL,
    vpp_app_team_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS public.vpp_app_upcoming_activities (
    upcoming_activity_id bigint NOT NULL,
    adam_id character varying(255) NOT NULL,
    platform character varying(10) NOT NULL,
    vpp_token_id integer,
...
CREATE TABLE IF NOT EXISTS public.vpp_apps (
    adam_id character varying(255) NOT NULL,
    title_id integer,
    bundle_identifier character varying(255) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vpp_apps_teams (
    id integer NOT NULL,
    adam_id character varying(255) NOT NULL,
    team_id integer,
    global_or_team_id integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vpp_token_teams (
    id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vpp_tokens (
    id integer NOT NULL,
    organization_name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vulnerability_host_counts (
    cve character varying(20) NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.windows_mdm_command_queue (
...
CREATE TABLE IF NOT EXISTS public.windows_mdm_command_results (
    enrollment_id integer NOT NULL,
    command_uuid character varying(127) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.windows_mdm_commands (
    command_uuid character varying(127) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.windows_mdm_responses (
    id integer NOT NULL,
    enrollment_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.windows_updates (
    id integer NOT NULL,
    host_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.wstep_cert_auth_associations (
    id character varying(255) NOT NULL,
    sha256 character(64) NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS public.wstep_certificates (
    serial bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.wstep_serials (
    serial bigint NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
ALTER TABLE ONLY public.vulnerability_host_counts
    ADD CONSTRAINT cve_team_id_global_stats UNIQUE (cve, team_id, global_stats);
...
ALTER TABLE ONLY public.kernel_host_counts
    ADD CONSTRAINT kernel_host_counts_swap_os_version_id_team_id_software_id_key UNIQUE (os_version_id, team_id, software_id);
...
ALTER TABLE ONLY public.kernel_host_counts
    ADD CONSTRAINT kernel_host_counts_swap_pkey PRIMARY KEY (id);
...
CREATE INDEX IF NOT EXISTS idx_auto_rotate_at ON public.host_recovery_key_passwords USING btree (auto_rotate_at);


--
--

CREATE INDEX IF NOT EXISTS idx_hdep_hardware_serial ON public.host_dep_assignments USING btree (hardware_serial);


--
--

CREATE INDEX IF NOT EXISTS idx_host_device_auth_previous_token ON public.host_device_auth USING btree (previous_token);


--
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_os_version_vulnerabilities_unq_os_version_team_cve2 ON public.operating_system_version_vulnerabilities USING btree (COALESCE(team_id, '-1'::integer), os_version_id, cve);


--
--

CREATE INDEX IF NOT EXISTS idx_policies_needs_full_membership_cleanup ON public.policies USING btree (needs_full_membership_cleanup);


--
--

CREATE INDEX IF NOT EXISTS idx_query_id_has_data_host_id_last_fetched ON public.query_results USING btree (query_id, has_data, host_id, last_fetched);


--
--

CREATE INDEX IF NOT EXISTS idx_software_installers_team_url ON public.software_installers USING btree (global_or_team_id);
