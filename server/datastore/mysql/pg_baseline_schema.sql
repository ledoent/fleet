...
CREATE TABLE IF NOT EXISTS "mdm_configuration_profile_labels" (
  ...
  CONSTRAINT "ck_mdm_configuration_profile_labels_profile_uuid" CHECK ((((CASE WHEN "apple_profile_uuid" IS NULL THEN 0 ELSE 1 END) + (CASE WHEN "windows_profile_uuid" IS NULL THEN 0 ELSE 1 END) + (CASE WHEN "android_profile_uuid" IS NULL THEN 0 ELSE 1 END)) = 1)),
  PRIMARY KEY ("id"),
