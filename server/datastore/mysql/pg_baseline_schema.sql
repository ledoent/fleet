...
CREATE TABLE IF NOT EXISTS public.host_mdm_windows_profiles (
    ...
    profile_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
    checksum bytea DEFAULT ' 000000000000000000000000000000'::bytea NOT NULL,
    secrets_updated_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: kernel_host_counts_swap; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.kernel_host_counts_swap (
    id integer NOT NULL,
    software_title_id integer,
    software_id integer,
    os_version_id integer,
...
--
-- Name: kernel_host_counts_swap_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
ALTER TABLE public.kernel_host_counts_swap ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS public.software_host_counts_swap (
    software_id bigint NOT NULL,
    hosts_count integer NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_titles_host_counts_swap (
    software_title_id integer NOT NULL,
    hosts_count integer NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
--
-- Name: vulnerability_host_counts_swap; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.vulnerability_host_counts_swap (
    cve character varying(20) NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    host_count integer DEFAULT 0 NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
--
-- Name: vulnerability_host_counts cve_team_id_global_stats; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: kernel_host_counts kernel_host_counts_swap_os_version_id_team_id_software_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: kernel_host_counts_swap kernel_host_counts_swap_os_version_id_team_id_software_id_key1; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.kernel_host_counts_swap
    ADD CONSTRAINT kernel_host_counts_swap_os_version_id_team_id_software_id_key1 UNIQUE (os_version_id, team_id, software_id);


--
-- Name: kernel_host_counts kernel_host_counts_swap_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: kernel_host_counts_swap kernel_host_counts_swap_pkey1; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: vulnerability_host_counts_swap vulnerability_host_counts_swap_cve_team_id_global_stats_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vulnerability_host_counts_swap
