...
--
-- pg-baseline-up-to-migration: 20260513210000
--
...
CREATE TABLE public.vpp_client_users (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT vpp_client_users_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'registered'::character varying, 'retired'::character varying])::text[])))
);
...
--
-- Name: idx_software_installers_team_title_version; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_software_installers_team_title_version ON public.software_installers USING btree (global_or_team_id, title_id, version);
...
--
-- Name: kernel_host_counts_swap_os_version_id_software_id_hosts_cou_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX kernel_host_counts_swap_os_version_id_software_id_hosts_cou_idx ON public.kernel_host_counts USING btree (os_version_id, software_id, hosts_count);


--
-- Name: kernel_host_counts_swap_os_version_id_team_id_software_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX kernel_host_counts_swap_os_version_id_team_id_software_id_idx ON public.kernel_host_counts USING btree (os_version_id, team_id, software_id);


--
-- Name: kernel_host_counts_swap_software_title_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX kernel_host_counts_swap_software_title_id_idx ON public.kernel_host_counts USING btree (software_title_id);
...
--
-- Name: software_host_counts_swap_team_id_global_stats_hosts_count__idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX software_host_counts_swap_team_id_global_stats_hosts_count__idx ON public.software_host_counts USING btree (team_id, global_stats, hosts_count DESC, software_id);


--
-- Name: software_host_counts_swap_updated_at_software_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX software_host_counts_swap_updated_at_software_id_idx ON public.software_host_counts USING btree (updated_at, software_id);
...
--
-- Name: vulnerability_host_counts_swap_cve_team_id_global_stats_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX vulnerability_host_counts_swap_cve_team_id_global_stats_idx ON public.vulnerability_host_counts USING btree (cve, team_id, global_stats);
