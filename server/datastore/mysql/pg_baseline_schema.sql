...
--
-- pg-baseline-up-to-migration: 20260611202649
--
--
...
--
-- Name: mdm_windows_configuration_profiles_pending_delete; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.mdm_windows_configuration_profiles_pending_delete (
    profile_uuid character varying(37) DEFAULT ''::character varying NOT NULL,
    team_id integer DEFAULT 0 NOT NULL,
    name character varying(255) NOT NULL,
    syncml bytea NOT NULL,
...
--
-- Name: mdm_windows_configuration_profiles_pending_delete mdm_windows_configuration_profiles_pending_delete_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mdm_windows_configuration_profiles_pending_delete
    ADD CONSTRAINT mdm_windows_configuration_profiles_pending_delete_pkey PRIMARY KEY (profile_uuid);
...
--
-- Name: idx_host_mdm_windows_profiles_profile_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_host_mdm_windows_profiles_profile_uuid ON public.host_mdm_windows_profiles USING btree (profile_uuid);
