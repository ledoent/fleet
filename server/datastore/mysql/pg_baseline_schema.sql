...
--
-- Name: apple_software_update_assets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.apple_software_update_assets (
    id integer NOT NULL,
    class character varying(255) NOT NULL,
    product_version character varying(50) NOT NULL,
    build character varying(50) DEFAULT ''::character varying NOT NULL,
    posting_date date,
...
--
-- Name: apple_software_update_assets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.apple_software_update_assets ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.apple_software_update_assets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: host_mdm_apple_os_updates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.host_mdm_apple_os_updates (
    host_uuid character varying(255) NOT NULL,
    software_update_device_id character varying(255) DEFAULT ''::character varying NOT NULL,
    target_os_version character varying(50) DEFAULT ''::character varying NOT NULL,
    target_deadline timestamp(6) without time zone DEFAULT NULL::timestamp without time zone,
    resolved_at timestamp(6) without time zone DEFAULT NULL::timestamp without time zone,
    created_at timestamp(6) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp(6) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: apple_software_update_assets apple_software_update_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apple_software_update_assets
    ADD CONSTRAINT apple_software_update_assets_pkey PRIMARY KEY (id);
...
--
-- Name: host_mdm_apple_os_updates host_mdm_apple_os_updates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.host_mdm_apple_os_updates
    ADD CONSTRAINT host_mdm_apple_os_updates_pkey PRIMARY KEY (host_uuid);
...
--
-- Name: apple_software_update_assets idx_asset_class_version_build; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apple_software_update_assets
    ADD CONSTRAINT idx_asset_class_version_build UNIQUE (class, product_version, build);
...
--
-- Name: apple_software_update_assets apple_software_update_assets_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER apple_software_update_assets_set_updated_at BEFORE UPDATE ON public.apple_software_update_assets FOR EACH ROW EXECUTE FUNCTION public.fleet_set_updated_at();
...
--
-- Name: host_mdm_apple_os_updates host_mdm_apple_os_updates_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER host_mdm_apple_os_updates_set_updated_at BEFORE UPDATE ON public.host_mdm_apple_os_updates FOR EACH ROW EXECUTE FUNCTION public.fleet_set_updated_at();
