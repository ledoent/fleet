...
--
-- pg-baseline-up-to-migration: 20260506171058
--
...
CREATE TABLE public.acme_authorizations (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT acme_authorizations_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'valid'::character varying, 'invalid'::character varying, 'deactivated'::character varying, 'expired'::character varying, 'revoked'::character varying])::text[])))
);
...
CREATE TABLE public.acme_challenges (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT acme_challenges_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'valid'::character varying, 'invalid'::character varying, 'processing'::character varying])::text[])))
);
...
CREATE TABLE public.acme_orders (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT acme_orders_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'ready'::character varying, 'processing'::character varying, 'valid'::character varying, 'invalid'::character varying])::text[])))
);
...
--
-- Name: software_titles_host_counts software_titles_host_counts_swap_pkey1; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.software_titles_host_counts
    ADD CONSTRAINT software_titles_host_counts_swap_pkey1 PRIMARY KEY (software_title_id, team_id, global_stats);
...
--
-- Name: vulnerability_host_counts vulnerability_host_counts_swap_cve_team_id_global_stats_key1; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vulnerability_host_counts
    ADD CONSTRAINT vulnerability_host_counts_swap_cve_team_id_global_stats_key1 UNIQUE (cve, team_id, global_stats);
